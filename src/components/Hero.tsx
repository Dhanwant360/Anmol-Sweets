      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10 w-full">
        ...
        >
          ...
          <div className="flex flex-wrap gap-4">
            <button className="bg-primary text-on-primary px-10 py-4 font-bold rounded-lg hover:bg-primary/90 transition-all shadow-lg active:scale-95">
              View Menu
            </button>
            <button className="border border-secondary text-secondary px-10 py-4 font-bold rounded-lg hover:bg-secondary/5 transition-all active:scale-95">
              Our Story
            </button>
          </div>
        </motion.div>
