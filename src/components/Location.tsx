      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          ...
          <div className="lg:w-1/2 p-16 flex flex-col justify-center">
            ...
            <button className="bg-secondary text-on-secondary px-8 py-5 rounded-full flex items-center gap-3 hover:bg-secondary/90 transition-all active:scale-95 w-fit font-bold shadow-lg hover:shadow-secondary/20">
              <Navigation size={20} />
